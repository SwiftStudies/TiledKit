...
public extension Engine {
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: TilePostProcessor, Producer: ObjectFactory, Producer: LayerFactory, Producer: ObjectPostProcessor, Producer: LayerPostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapPostProcessor, Producer: TileFactory, Producer: TilePostProcessor, Producer: ObjectFactory, Producer: LayerFactory, Producer: ObjectPostProcessor, Producer: LayerPostProcessor, Producer: MapFactory {
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: TileFactory, Producer: ObjectFactory, Producer: MapFactory, Producer: TilePostProcessor, Producer: LayerPostProcessor, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: LayerPostProcessor, Producer: ObjectFactory, Producer: TileFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: MapPostProcessor, Producer: LayerPostProcessor, Producer: ObjectFactory, Producer: TileFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: TilePostProcessor, Producer: TileFactory, Producer: MapPostProcessor, Producer: ObjectFactory, Producer: LayerFactory, Producer: LayerPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: LayerPostProcessor, Producer: ObjectFactory, Producer: LayerFactory, Producer: TileFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: LayerPostProcessor, Producer: ObjectFactory, Producer: TileFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: MapFactory, Producer: MapPostProcessor, Producer: ObjectFactory, Producer: LayerFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: ObjectFactory, Producer: MapPostProcessor, Producer: TileFactory, Producer: LayerFactory, Producer: TilePostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: MapPostProcessor, Producer: ObjectFactory, Producer: MapFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: ObjectPostProcessor, Producer: MapPostProcessor, Producer: ObjectFactory, Producer: MapFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: ObjectFactory, Producer: LayerFactory, Producer: MapFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: ObjectFactory, Producer: LayerFactory, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: MapFactory, Producer: ObjectFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: MapFactory, Producer: ObjectFactory, Producer: TileFactory, Producer: ObjectPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: MapPostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: TileFactory, Producer: LayerPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: TileFactory, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: ObjectFactory, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: MapPostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: MapPostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: TileFactory, Producer: ObjectPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: MapFactory, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: LayerPostProcessor, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: MapFactory, Producer: LayerPostProcessor, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapPostProcessor, Producer: ObjectFactory, Producer: TileFactory, Producer: LayerPostProcessor, Producer: MapFactory, Producer: ObjectPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapPostProcessor, Producer: ObjectFactory, Producer: TileFactory, Producer: LayerPostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: ObjectFactory, Producer: ObjectPostProcessor, Producer: LayerPostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: ObjectFactory, Producer: TileFactory, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectFactory, Producer: MapPostProcessor, Producer: TileFactory, Producer: ObjectPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: ObjectFactory, Producer: MapFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: TileFactory, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: ObjectFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: MapPostProcessor, Producer: TilePostProcessor, Producer: LayerFactory, Producer: MapFactory, Producer: LayerPostProcessor, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapPostProcessor, Producer: TilePostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: ObjectFactory, Producer: LayerPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: ObjectFactory, Producer: LayerPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: TilePostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: ObjectFactory, Producer: LayerPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapPostProcessor, Producer: TilePostProcessor, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapPostProcessor, Producer: TilePostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: TilePostProcessor, Producer: MapPostProcessor, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: LayerPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: TilePostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: LayerPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: TilePostProcessor, Producer: MapPostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: TilePostProcessor, Producer: MapPostProcessor, Producer: ObjectPostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: ObjectPostProcessor, Producer: LayerPostProcessor, Producer: MapFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: TilePostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: ObjectFactory, Producer: MapFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: LayerPostProcessor, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: MapPostProcessor, Producer: LayerPostProcessor, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerFactory, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: MapPostProcessor, Producer: LayerPostProcessor, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerFactory, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: LayerPostProcessor, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapFactory, Producer: ObjectFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapFactory, Producer: ObjectFactory, Producer: MapPostProcessor, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: MapFactory, Producer: LayerFactory, Producer: LayerPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectFactory, Producer: MapFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: MapPostProcessor, Producer: LayerFactory, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectFactory, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: LayerFactory, Producer: ObjectPostProcessor, Producer: ObjectFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: TilePostProcessor, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: TilePostProcessor, Producer: TileFactory, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: TilePostProcessor, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: TilePostProcessor, Producer: TileFactory, Producer: ObjectPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: TilePostProcessor, Producer: ObjectPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: TilePostProcessor, Producer: LayerFactory, Producer: ObjectPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: TilePostProcessor, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapFactory, Producer: TileFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapFactory, Producer: TileFactory, Producer: ObjectPostProcessor, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapFactory, Producer: TileFactory, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapFactory, Producer: TileFactory, Producer: LayerFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapPostProcessor, Producer: LayerPostProcessor, Producer: MapFactory, Producer: ObjectPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapPostProcessor, Producer: LayerFactory, Producer: LayerPostProcessor, Producer: MapFactory, Producer: ObjectPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: LayerFactory, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: TilePostProcessor, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: TilePostProcessor, Producer: TileFactory, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: TileFactory, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: LayerFactory, Producer: MapFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: LayerFactory, Producer: MapFactory, Producer: TileFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: LayerFactory, Producer: LayerPostProcessor, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: TileFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: TileFactory, Producer: LayerPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: LayerPostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: TilePostProcessor, Producer: MapFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: LayerPostProcessor, Producer: TilePostProcessor, Producer: MapFactory {
        EngineRegistry.insert(for: Self.self, object: AnyLayerPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: TilePostProcessor, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: TilePostProcessor, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: LayerFactory, Producer: TileFactory, Producer: TilePostProcessor, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: TileFactory, Producer: TilePostProcessor, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: MapPostProcessor, Producer: TileFactory, Producer: MapFactory, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TilePostProcessor, Producer: MapPostProcessor, Producer: MapFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: TilePostProcessor, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: TilePostProcessor, Producer: LayerFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: TilePostProcessor, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: TilePostProcessor, Producer: LayerFactory, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: MapFactory, Producer: TilePostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTilePostProcessor(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: LayerFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: MapFactory, Producer: MapPostProcessor, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: MapPostProcessor, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: ObjectPostProcessor, Producer: MapFactory, Producer: LayerFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: TileFactory, Producer: MapFactory, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: MapPostProcessor, Producer: TileFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: MapPostProcessor {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyEngineMapPostProcessor(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: ObjectPostProcessor, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyObjectPostProcessor(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    }
    ...
    /// Add a new post processor to the post processors for the `Engine`, new post processors  are tried first
    /// - Parameter producer: The `EngineProducer` to be registered. All of the appropriate capabilities will be registered (e.g. MapFactory & MapPostProcessor)
    static func register<Producer>(producer:Producer) where Producer.EngineType == Self, Producer: MapFactory, Producer: TileFactory, Producer: LayerFactory {
        EngineRegistry.insert(for: Self.self, object: AnyMapFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyTileFactory(wrap: producer))
        EngineRegistry.insert(for: Self.self, object: AnyLayerFactory(wrap: producer))
    }
